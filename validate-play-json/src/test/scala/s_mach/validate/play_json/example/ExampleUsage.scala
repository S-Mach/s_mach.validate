...
object Name {
  ...
  implicit val explainFormat_Name =
    ExplainFormat.forValueClass[Name,String].withValidator
}
...
implicit val explainFormat_Age =
  ExplainFormat.forDistinctTypeAlias[Age,Int].withValidator
...
object Family {
  ...
  implicit val explainFormat_Family = ExplainFormat.forProductType[Family].withValidator
}
