...
//
//class ExplainFormatTypeRemarksPrinterTest extends FlatSpec with Matchers {
...
//    explainFormat[Name].toTypeRemarks.print should equal(List(
//      "this: must be string",
...
//    explainFormat[WeightLb].toTypeRemarks.print should equal(List(
//      "this: must be number",
...
//    explainFormat[Person].toTypeRemarks.print should equal(List(
...
//    explainFormat[Family].toTypeRemarks.print should equal(List(
