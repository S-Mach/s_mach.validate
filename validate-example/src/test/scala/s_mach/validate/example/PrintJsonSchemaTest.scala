...
"""{
  ...
  "ExplainJsonSchema[Person]" should "correctly print JSON for a single case class validator" in {
    explainPlayJson[Person].printJsonSchema[JsValue]("http://test.org").pretty should equal(
"""{
  "$schema" : "http://json-schema.org/draft-04/schema#",
  "id" : "http://test.org",
  "type" : "object",
  ...
  "ExplainJsonSchema[Family]" should "correctly print JSON for a nested case class validator" in {
    explainPlayJson[Family].printJsonSchema[JsValue]("http://test.org").pretty should equal(
"""{
  "$schema" : "http://json-schema.org/draft-04/schema#",
  "id" : "http://test.org",
  "type" : "object",
