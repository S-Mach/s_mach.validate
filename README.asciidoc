...
primitive field.
* Validators return +List[Explain]+ or +List[Rule]+ which are serialization format agnostic.
* Convenience methods for converting to Play JSON are provided.
...
* You want to be able to create case class instances that might contain invalid data (as opposed to construction based
